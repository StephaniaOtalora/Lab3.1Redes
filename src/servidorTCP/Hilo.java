...
public class Hilo extends Thread {
	...
	public final static String ARCHIVO_PATH_1 = "data/archivos/100mib.pdf";
	public final static String ARCHIVO_PATH_2 = "data/archivos/250mib.mp4";
	...
	public Hilo(Socket pSocket, int arch, BufferedWriter writer, int numCliente) {
		socket = pSocket;
		this.writer = writer;
